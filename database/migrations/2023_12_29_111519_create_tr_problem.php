...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('tr_problem', function (Blueprint $table) {
            $table->id();
            ...
            $table->text('gejala_problem')->nullable();
            $table->text('kronologi_problem')->nullable();
            $table->text('root_cause_analysis_result')->nullable();
            $table->text('workaround')->nullable();
            $table->text('major_problem_review')->nullable();
    ...
    {
        Schema::dropIfExists('tr_problem');
    }
};
