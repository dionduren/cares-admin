                                ...
                                <div class="mb-4 mb-md-5 text-center">
                                    <a href="<?php echo e(url('/')); ?>" class="d-block auth-logo">
                                        <img src="<?php echo e(URL::asset('assets/images/logo-sm.svg')); ?>" alt=""
                                            height="28"> <span class="logo-txt">CARES</span>
                                    </a>
                                </div>
...
unset($__errorArgs, $__bag); ?>"
                                            value="<?php echo e(old('nik')); ?>" id="input-username" placeholder="Enter User Name"
                                            name="nik">
                                        <?php $__errorArgs = ['nik'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3">
                                        <button class="btn btn-primary w-100 waves-effect waves-light" id="loginButton"
                                ...
                                <div class="mt-4 mt-md-5 text-center">
                                    <p class="mb-0">©
                                        ...
                                        </script> Pupuk Indonesia . Crafted with Dason by Themesdesign
                                    </p>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Kerjaan\Pupuk Indonesia - TI\2023\01. Remake Cares\Project\cares-admin\resources\views/auth/login.blade.php ENDPATH**/ ?>